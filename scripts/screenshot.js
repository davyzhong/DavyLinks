/**
 * DavyLinks README 渲染截图（Playwright）
 *
 * 用途：
 *   DavyLinks 是链接处理管线工具，没有本地可执行入口。
...
const REPO_URL = 'https://github.com/davyzhong/DavyLinks';
...
const SCREENSHOT_CONFIG = [
  {
    ...
    selector: 'article',
    description: 'DavyLinks README 桌面端渲染快照（1280×800）',
  },
  {
    name: 'readme-mobile.png',
    viewport: { width: 390, height: 844 }, // iPhone 14 视口
    selector: 'article',
    description: 'DavyLinks README 移动端渲染快照（390×844）',
  },
];
...
async function main() {
  console.log(`📸 DavyLinks README 截图自动化（Playwright）`);
